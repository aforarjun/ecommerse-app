...
const Wishlist = ({ setOpenWishlist }: any) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-[#0000004b] h-screen z-10">
      <div className="fixed top-0 right-0 h-full w-[80%] overflow-y-scroll 800px:w-[400px] bg-white flex flex-col justify-between shadow-sm">
        {wishlist.length === 0 ? (
...
const CartSingle = ({ data, removeFromWishlistHandler, addToCartHandler }: any) => {
